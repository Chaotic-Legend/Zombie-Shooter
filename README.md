[![Static Badge](https://img.shields.io/badge/Godot%20Engine-4.6.3-blue?style=plastic&logo=godotengine)](https://godotengine.org/) ![GitHub top language](https://img.shields.io/github/languages/top/Chaotic-Legend/Zombie-Shooter?logo=godotengine)
...
This project is a beginner-friendly walkthrough for building a top-down 2D zombie survival shooter in the Godot Engine, focusing on the core systems required for responsive twin-stick style combat, enemy pursuit behavior, and wave-based survival gameplay. It introduces and applies essential concepts, including node-based scene organization, character movement and aiming systems, projectile shooting mechanics, path-following behavior, collision detection, health and damage systems, score tracking, UI implementation, audio integration, and game state management. This tutorial also demonstrates important gameplay features, including dynamic enemy spawning, persistent enemy behavior, crosshair-based aiming, pause and reset functionality, background music management, visual combat feedback, and structured game flow that supports both player progression and replayability. The result is a fully playable zombie survival experience in which players must eliminate increasingly dangerous hordes of enemies, manage positioning and movement, maintain accuracy under pressure, and survive as long as possible to achieve higher scores. It also served as the foundation for completing a structured implementation task on Feather, with the project integrated into the broader development workflow supporting the Handshake AI Project Touchstone initiative.
...
![Sprite Asset](assets/textures/topdown_character.png)
![Sprite Asset](assets/textures/zombie.png)
